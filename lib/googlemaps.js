...
exports.places = function(latlng, radius, key, callback, sensor, types, language, name) {
  var args = {
    location: latlng,
    radius: radius,
    key: key
...
exports.placesAutocomplete = function(input, latlng, radius, key, callback, sensor, types, language) {
  var args = {
    input: input,
    location: latlng,
    radius: radius,
...
exports.placesTextsearch = function(query, latlng, radius, key, callback, sensor, types, language) {
  var args = {
    query: query,
    location: latlng,
    radius: radius,
