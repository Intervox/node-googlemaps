...
exports.placesAutocomplete = function(input, latlng, radius, key, callback, sensor, types, lang) {
  var args = {
    input: input,
    location: latlng,
    radius: radius,
...
exports.placesTextsearch = function(query, latlng, radius, key, callback, sensor, types, lang) {
  var args = {
    query: query,
    location: latlng,
    radius: radius,
